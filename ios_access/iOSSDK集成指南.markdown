 ...
 * libsqlite3.0.tbd 
添加完成以后,库的引用如下: 
![](https://ws3.sinaimg.cn/large/006tKfTcgy1fr6ivuqv7nj31au0ccmz6.jpg)

4. 在工程配置和后台模式中打开推送,如下图 

![](https://ws3.sinaimg.cn/large/006tKfTcgy1fr6ivrvwqvj30k70n176i.jpg)

5. 添加编译参数 ```-ObjC``` 

![](https://ws3.sinaimg.cn/large/006tKfTcgy1fr6iwjvbr0j31ce09yjtg.jpg)
...
![QQ登录](https://ws2.sinaimg.cn/large/006tNc79gy1frannpkm2fj30d807wmxg.jpg)

第二步，选择应用名称，点击 ```Open My Project``` ，打开工程项目的``` .xcodeproj``` 文件

![集成SDK](https://ws3.sinaimg.cn/large/006tNc79gy1fransbmdf5j30d407x75i.jpg)
