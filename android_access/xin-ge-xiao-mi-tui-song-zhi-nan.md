...
小米通道是信鸽和小米合作的推送通道。在小米手机上，消息通过小米的系统通道抵达终端无需打开应用就能够收到推送，在非小米手机依旧使用信鸽的推送通道（在非小米手机上应用不在前台运行无法保证一定能够收到推送消息。）次功能必须先集成信鸽3.2beta版本。
...
1.引入小米推送的jar包
 ```xml
   ...
   //需要在信鸽的集成基础上新增小米push的jar包
    ...
    compile 'com.tencent.xinge:xmipush:3.5.1-release'
```
